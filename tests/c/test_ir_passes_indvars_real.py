...
"""
    ...
    def test_duplicate_ivs_are_not_merged_across_functions(self):
        ir = """
...
"""
        out, changed = indvars_text(ir)
        self.assertTrue(changed)
        second = out.split("define i64 @second", 1)[1]
        self.assertIn("%j = phi i64", second)
        self.assertNotIn("%i", second)
