...
our %config = (
    ...
    "openssldir" => "",
    "options" => " no-acvp-tests no-afalgeng no-apps no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-default-thread-pool no-demos no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-jitter no-ktls no-loadereng no-md2 no-module no-msan no-pie no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-tfo no-thread-pool no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "1",
    ...
    "dirinfo" => {
        ...
        "crypto/aes" => {
            "deps" => [
                ...
                "crypto/aes/libcrypto-lib-bsaes-armv8.o",
        ...
        "crypto/chacha" => {
            "deps" => [
                "crypto/chacha/libcrypto-lib-chacha-armv8-sve.o",
        ...
        "crypto/ec" => {
            "deps" => [
                ...
                "crypto/ec/libcrypto-lib-ecp_sm2p256-armv8.o",
                "crypto/ec/libcrypto-lib-ecp_sm2p256.o",
        ...
        "crypto/md5" => {
            "deps" => [
                "crypto/md5/libcrypto-lib-md5-aarch64.o",
        ...
        "crypto/modes" => {
            "deps" => [
                "crypto/modes/libcrypto-lib-aes-gcm-armv8-unroll8_64.o",
        ...
        "crypto/sm3" => {
            "deps" => [
                ...
                "crypto/sm3/libcrypto-lib-sm3-armv8.o",
        ...
        "crypto/sm4" => {
            "deps" => [
                "crypto/sm4/libcrypto-lib-sm4-armv8.o",
                "crypto/sm4/libcrypto-lib-sm4.o",
                "crypto/sm4/libcrypto-lib-vpsm4-armv8.o",
                "crypto/sm4/libcrypto-lib-vpsm4_ex-armv8.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto"
...
unless (caller) {
    ...
    use lib '/Users/liuhuan/pcc/projects/openssl-3.4.1/util/perl';
    use OpenSSL::fallback '/Users/liuhuan/pcc/projects/openssl-3.4.1/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/liuhuan/pcc/projects/openssl-3.4.1/Configurations';
        use gentemplate;
