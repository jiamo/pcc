...
## Chapter Overview: First Ask Who Owns the Reference
...
### Case study one: a borrowed return breaks the bootstrap (2026-06-01)
...
### Case study two: the owned flag cache that leaked across functions
