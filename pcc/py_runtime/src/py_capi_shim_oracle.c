...
/* Oracle mirror of pcc_capi_cext_object_length (py_capi_shim.c). len() for a
 * cext object: mp_length, else sq_length; -1 when the type has neither so
 * py_obj_len falls through to the user-class __len__ dispatch. */
